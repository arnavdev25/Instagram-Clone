    ...
    <div>
      <div className={styles.homemain}>
        ...
        <div className={style.home2}>
          ...
          >
            ...
            >
              <img
                height="14px"
                width="14px"
                src="https://www.bing.com/th?id=OIP.aYVbqEFb2M-SWsBh_LafIQHaHa&w=250&h=250&c=8&rs=1&qlt=90&o=6&dpr=1.25&pid=3.1&rm=2"
                alt="facebook"
              />
              <span style={{ color: "#385185", cursor: "pointer" }}>
                Login with Facebook
              </span>
            </div>
            <br />
            <a
              style={{ color: "rgba(var(--fe0,0,55,107),1)", fontSize: "13px" }}
              href="#"
            >
              Forgot Password?
            </a>
          ...
          >
            <p style={{ color: "rgba(var(--i1d,38,38,38),1)" }}>
              Don't have an account?{" "}
              <a
                style={{ color: "rgba(var(--d69,0,149,246),1)" }}
                href="/signup"
              >
                Sign up
              </a>{" "}
